...
#Here, tdam is a new variable within damanges (data.frame) that is constructed by the command given. 
...
#geom_bar means make a bar graph, identiry means data as is (multiple by 1), fill means color you want to use
